...
class BO_algo():
    ...
    def next_recommendation(self):
        ...
        if self.x_sample.size == 0:
            ...
            if len(self.f_sample) == 13 and np.all(self.f_sample < 0.3):
    ...
    def acquisition_function(self, x):
        ...
        """
        ei = self.expected_improvement(x, xi=0.012)
    ...
    def constraint_function(self, x):
        ...
        if sigma != 0:
            ...
            pr = 0.95 * (mu - self.v_min) if mu >= self.v_min else 0.05 * (self.v_min - mu)
